...
Gem::Specification.new do |spec|
  ...
  spec.description = "This Ruby gem provides an easy-to-use client for interacting with the Bling API. With this gem, you can manage products, orders, and other resources in your Bling account using a simple Ruby interface."
